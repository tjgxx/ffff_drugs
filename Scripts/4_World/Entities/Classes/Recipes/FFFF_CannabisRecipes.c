// class FFFF_CraftGlowMushroomsBagGreen extends RecipeBase
// {	
// 	override void Init()
// 	{
// 		m_Name = "Bag Weed";
...
// 		InsertIngredient(0,"FFFF_Cannabis");//you can insert multiple ingredients this way
...
// 		//result1
// 		AddResult("FFFF_Cannabis_Bag");//add results here
